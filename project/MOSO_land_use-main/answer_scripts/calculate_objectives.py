...
tot_yield = calculate_tot_yield(landuse, sugarcane_pot_yield,soy_pot_yield,sugarcane_pot_yield,pasture_pot_yield,6.25)
print(tot_yield)

tot_biomass = calculate_above_ground_biomass(landuse,6.25)
print(tot_biomass)
"""